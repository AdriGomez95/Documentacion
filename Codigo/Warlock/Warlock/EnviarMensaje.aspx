<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnviarMensaje.aspx.cs" Inherits="Warlock.EnviarMensaje" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="img/cssMensaje.css">
</head>
<body>
        ...
        <div>
            <div id="menu">
                <ul>
                    ...
                    <li class="centro"><a href="Mensajes.html">Enviar Mensaje </a></li>
                ...
                <table id="tablainicio">
                    <tr>
                        <td>
                            ...
                            <br>
                            <font color="white" face="Comic Sans MS"><p align="center">Usuario:  
            		<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                    
                    <br/>
                    <font color="white" face="Comic Sans MS"><p align="center">Mensaje:
            		<asp:TextBox ID="TextBox2" runat="server" Height="106px" Width="214px"></asp:TextBox>
            		<br />
